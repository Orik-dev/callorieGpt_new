...
КОГДА EDIT:
- ТОЛЬКО когда пользователь ЯВНО хочет ИСПРАВИТЬ уже добавленную запись
- Ключевые слова: "исправь", "поменяй", "измени", "там было X, не Y", "не 200 а 150", "на самом деле было"
- Пользователь ССЫЛАЕТСЯ на уже записанное блюдо: "в гречке было не 200, а 150г", "исправь курицу"
- edit_target: название блюда для поиска, или "last" если не указано
- ⚠️ ЕСЛИ пользователь описывает НОВЫЙ продукт (которого нет в контексте сегодняшних записей) — это ВСЕГДА ADD, даже если в тексте есть слово "было"
